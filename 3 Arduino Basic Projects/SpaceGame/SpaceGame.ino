...
const char titleAuthor[] = "RIYAZ PATHAN";
const char titleGame[] = "SPACE SHOOTER";
const char titlePrompt[] = "Press FIRE to PLAY";
...
void showStartupScreen() {
  ...
  do {
    ...
    u8g2.setCursor((SCREEN_WIDTH - u8g2.getStrWidth(titleAuthor)) / 2, 20);
    u8g2.print(titleAuthor);
    u8g2.setCursor((SCREEN_WIDTH - u8g2.getStrWidth(titleGame)) / 2, 35);
    u8g2.print(titleGame);
    u8g2.setCursor((SCREEN_WIDTH - u8g2.getStrWidth(titlePrompt)) / 2, 50);
    u8g2.print(titlePrompt);
  } while (u8g2.nextPage());
}
